...
export const getJoke = async (): Promise<string> => {
  try {
    if (!process.env.API_KEY) {
        throw new Error("API_KEY environment variable not set. Please ensure you have a .env file with VITE_API_KEY for local development, or have it set in your deployment environment.");
    }
